 ...
 */
class TransformPaymentResourse extends Transform {
    ...
    _transform( chunk, encoding, callback ) {
        ...
        if( строка.length === 2 ) {
            ...
            итог['number_document'] = строка[5] == undefined ? '' : строка[5].trim();
            итог['date_document'] = строка[6] == undefined ? '' : строка[6].trim();
            итог.period = this.period;
            callback(null,итог);
        }
    }
}
module.exports = TransformPaymentResourse;