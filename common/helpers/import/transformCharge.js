 ...
 */
class TransformCharge extends Transform {
    ...
    _transform( chunk, encoding, callback ) {
        ...
        if( строка.length === 2 ) {
            ...
            итог.recalculate = строка[6] == undefined ? '' : строка[6].trim();
            итог.quality = строка[7] == undefined ? '' : строка[7].trim();
            итог.period = this.period;
            callback(null,итог);
        }
    }
}
module.exports = TransformCharge;